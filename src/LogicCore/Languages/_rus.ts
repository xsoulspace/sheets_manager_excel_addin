...
export const rus: LangFile = {
	introTour: {
		...
		'item-name': {
			...
			content: `можно изменить дважды кликнув. Изменить на тач скринах - долгим нажатием`,
		},
		'item-numeration': {
			title: 'Нумерация',
	...
	settings: {
		...
		sheetsNumerationEnabled: `Группировка листов (все листы будут пронумерованы)`,
	...
	brokenNumeration: {
		...
		tryToRecover: 'Попробовать восстановить нумерацию? Внимание! Все листы будут пронумерованы!'
	},
	buttons: {
		yes: 'Да',
		no: 'Нет',
