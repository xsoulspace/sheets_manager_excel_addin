...
export default class SettingsModal extends Vue {
  ...
  changeShouldWeRestoreNumeration() {
    ...
    let title = `${this.$t('alerts.numerationRecover')} ${
      newState ? this.$t('alerts.activated') : this.$t('alerts.deactivated')
    }`
  ...
  switchIntroOnOpenState() {
    ...
    let title = `${this.$t('alerts.onOpenTutorial')} ${
      newState ? this.$t('alerts.activated') : this.$t('alerts.deactivated')
    }`
  ...
  async changeIsNumerated() {
    ...
    let title = `${this.$t('alerts.numeration')} ${
      newState ? this.$t('alerts.activated') : this.$t('alerts.deactivated')
    }`
  ...
  switchNumeration() {
    ...
    let title = `${this.$t('alerts.numerationVisibility')} ${
      newState ? this.$t('alerts.activated') : this.$t('alerts.deactivated')
    }`
